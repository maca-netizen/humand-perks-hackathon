  ...
  return (
    <div className="min-h-screen bg-[#F8F9FB]">
      ...
      <header className="bg-white px-4 py-4 flex items-center gap-3">
        ...
        <h1 className="text-[18px] font-semibold text-[#2D3748]">Beneficios</h1>
      </header>
      ...
      <main className="max-w-lg mx-auto px-5 py-4 pb-28">
        ...
        {/* Results Count */}
        <p className="text-[13px] text-[#718096] mb-4">
          {filteredPerks.length} beneficio{filteredPerks.length !== 1 ? "s" : ""} disponible{filteredPerks.length !== 1 ? "s" : ""}
        </p>
        ...
        {filteredPerks.length === 0 && (
          <div className="text-center py-12">
            <p className="text-[#718096]">No se encontraron beneficios.</p>
          </div>
        )}
      </main>
    </div>
