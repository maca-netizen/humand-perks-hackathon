...
/* ════════════════════════════════════════════
   ...
   ════════════════════════════════════════════ */
const mockUsers = [
  { id: 1, name: "María García", email: "maria.garcia@empresa.com", dept: "Marketing", credits: 1500, spent: 850, avatar: "MG", status: "active" },
  { id: 2, name: "Carlos López", email: "carlos.lopez@empresa.com", dept: "Tecnología", credits: 2000, spent: 1200, avatar: "CL", status: "active" },
  { id: 3, name: "Ana Martínez", email: "ana.martinez@empresa.com", dept: "RRHH", credits: 1800, spent: 600, avatar: "AM", status: "active" },
  { id: 4, name: "Pedro Sánchez", email: "pedro.sanchez@empresa.com", dept: "Ventas", credits: 1500, spent: 1500, avatar: "PS", status: "active" },
  { id: 5, name: "Laura Fernández", email: "laura.fernandez@empresa.com", dept: "Finanzas", credits: 2200, spent: 900, avatar: "LF", status: "active" },
  { id: 6, name: "Diego Torres", email: "diego.torres@empresa.com", dept: "Tecnología", credits: 1500, spent: 300, avatar: "DT", status: "inactive" },
  { id: 7, name: "Sofía Ruiz", email: "sofia.ruiz@empresa.com", dept: "Marketing", credits: 1800, spent: 1100, avatar: "SR", status: "active" },
  { id: 8, name: "Mateo Herrera", email: "mateo.herrera@empresa.com", dept: "Ventas", credits: 1500, spent: 750, avatar: "MH", status: "active" },
];

const mockBenefits = [
  { id: 1, name: "Gimnasio mensual", category: "Bienestar", credits: 500, provider: "SmartFit", status: "active", redemptions: 45, image: "🏋️" },
  { id: 2, name: "Día libre extra", category: "Tiempo libre", credits: 800, provider: "Interno", status: "active", redemptions: 32, image: "🌴" },
  { id: 3, name: "Curso online", category: "Educación", credits: 600, provider: "Coursera", status: "active", redemptions: 28, image: "📚" },
  { id: 4, name: "Almuerzo gourmet", category: "Gastronomía", credits: 300, provider: "PedidosYa", status: "active", redemptions: 67, image: "🍽️" },
  { id: 5, name: "Sesión de masajes", category: "Bienestar", credits: 450, provider: "ZenSpa", status: "active", redemptions: 19, image: "💆" },
  { id: 6, name: "Streaming anual", category: "Entretenimiento", credits: 400, provider: "Spotify", status: "paused", redemptions: 55, image: "🎵" },
  { id: 7, name: "Gift card tienda", category: "Shopping", credits: 700, provider: "MercadoLibre", status: "active", redemptions: 38, image: "🛍️" },
  { id: 8, name: "Transporte mensual", category: "Movilidad", credits: 350, provider: "Uber", status: "active", redemptions: 41, image: "🚗" },
];
        ...
        <div style={{ padding: "16px 24px 24px" }}>
          <Table
            columns={[
              ...
              { header: "Créditos/usuario", key: "credits", render: r => r.credits.toLocaleString() },
              { header: "Total", key: "total", render: r => <span style={{ fontWeight: 600 }}>{r.total.toLocaleString()}</span> },
        ...
        <div style={{ padding: "0 24px 24px" }}>
          <Table
            columns={[
              ...
              { header: "Créditos cargados", key: "credits", render: r => r.credits.toLocaleString() },
              { header: "Créditos usados", key: "spent", render: r => r.spent.toLocaleString() },
              { header: "Disponible", key: "available", render: r => {
                const avail = r.credits - r.spent;
                return <span style={{ fontWeight: 600, color: avail > 0 ? tokens.colors.green[600] : tokens.colors.red[500] }}>{avail.toLocaleString()}</span>;
              }},
              { header: "Estado", key: "status", render: r => (
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 12, padding: 16, background: tokens.colors.neutral[50], borderRadius: tokens.radius.m, marginBottom: 20 }}>
            ...
            <div>
              ...
              <div style={{ fontSize: 12, color: tokens.colors.green[600], marginTop: 2, letterSpacing: "0.2px" }}>
                Disponible: {(selected.credits - selected.spent).toLocaleString()} créditos
              </div>
            </div>
          </div>
                    ...
                    <div key={rule.id} style={{
                      ...
                      <div style={{ flex: 1 }}>
                        ...
                        <div style={{ fontSize: 12, color: tokens.semantic.textLighter, marginTop: 4, letterSpacing: "0.2px", lineHeight: 1.4 }}>
                          Trigger: {rule.trigger} · {rule.amount.toLocaleString()} créditos · {rule.target}
                        </div>
            ...
            <div style={{ padding: "16px 24px" }}>
              <Table
                columns={[
                  ...
                  { header: "Créditos", key: "amount", render: r => <span style={{ fontWeight: 600 }}>{r.amount.toLocaleString()}</span> },
            ...
            <div style={{ padding: "16px 24px" }}>
              <Table
                columns={[
                  ...
                  { header: "Créditos total", key: "amount", render: r => <span style={{ fontWeight: 600 }}>{(r.amount * 85).toLocaleString()}</span> },
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
            {topUsers.map((u, i) => (
              <div key={u.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "8px 0", borderBottom: i < topUsers.length - 1 ? `1px solid ${tokens.semantic.borderLight}` : "none" }}>
                ...
                <div style={{ textAlign: "right" }}>
                  <div style={{ fontWeight: 600, fontSize: 14, letterSpacing: "0.2px" }}>{u.spent.toLocaleString()}</div>
